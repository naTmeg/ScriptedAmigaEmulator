...
function Custom() {
	...
	this.load16_real = function (hpos, addr, noput) {
		...
		switch (addr & 0x1fe) {
			...
			case 0x014: v = AMIGA.input.POT1DAT(); break;
			case 0x016: v = AMIGA.input.POTGOR(); break;
			case 0x018: v = AMIGA.serial.SERDATR(); break;
			case 0x01A: v = AMIGA.disk.DSKBYTR(hpos); break;
			case 0x01C: v = AMIGA.INTENAR(); break;
			case 0x01E: v = AMIGA.INTREQR(); break;
			case 0x07C: {
...
/*#ifdef AGA
	...
	this.store16_real = function (hpos, addr, value, noget) {
		...
		switch (addr) {
			...
			case 0x034: AMIGA.input.POTGO(value); break;

			case 0x040: AMIGA.blitter.BLTCON0(hpos, value); break;
			case 0x042: AMIGA.blitter.BLTCON1(hpos, value); break;

			case 0x044: AMIGA.blitter.BLTAFWM(hpos, value); break;
			case 0x046: AMIGA.blitter.BLTALWM(hpos, value); break;

			case 0x050: AMIGA.blitter.BLTAPTH(hpos, value); break;
			case 0x052: AMIGA.blitter.BLTAPTL(hpos, value); break;
			case 0x04C: AMIGA.blitter.BLTBPTH(hpos, value); break;
			case 0x04E: AMIGA.blitter.BLTBPTL(hpos, value); break;
			case 0x048: AMIGA.blitter.BLTCPTH(hpos, value); break;
			case 0x04A: AMIGA.blitter.BLTCPTL(hpos, value); break;
			case 0x054: AMIGA.blitter.BLTDPTH(hpos, value); break;
			case 0x056: AMIGA.blitter.BLTDPTL(hpos, value); break;

			case 0x058: AMIGA.blitter.BLTSIZE(hpos, value); break;

			case 0x064: AMIGA.blitter.BLTAMOD(hpos, value); break;
			case 0x062: AMIGA.blitter.BLTBMOD(hpos, value); break;
			case 0x060: AMIGA.blitter.BLTCMOD(hpos, value); break;
			case 0x066: AMIGA.blitter.BLTDMOD(hpos, value); break;

			case 0x070: AMIGA.blitter.BLTCDAT(hpos, value); break;
			case 0x072: AMIGA.blitter.BLTBDAT(hpos, value); break;
			case 0x074: AMIGA.blitter.BLTADAT(hpos, value); break;

			case 0x07E: AMIGA.disk.DSKSYNC(value, hpos); break;

			case 0x080: AMIGA.copper.COP1LCH(value); break;
			case 0x082: AMIGA.copper.COP1LCL(value); break;
			case 0x084: AMIGA.copper.COP2LCH(value); break;
			case 0x086: AMIGA.copper.COP2LCL(value); break;
			...
			case 0x0A0: AMIGA.audio.AUDxLCH(0, value); break;
			case 0x0A2: AMIGA.audio.AUDxLCL(0, value); break;
			case 0x0A4: AMIGA.audio.AUDxLEN(0, value); break;
			case 0x0A6: AMIGA.audio.AUDxPER(0, value); break;
			case 0x0A8: AMIGA.audio.AUDxVOL(0, value); break;
			case 0x0AA: AMIGA.audio.AUDxDAT(0, value); break;

			case 0x0B0: AMIGA.audio.AUDxLCH(1, value); break;
			case 0x0B2: AMIGA.audio.AUDxLCL(1, value); break;
			case 0x0B4: AMIGA.audio.AUDxLEN(1, value); break;
			case 0x0B6: AMIGA.audio.AUDxPER(1, value); break;
			case 0x0B8: AMIGA.audio.AUDxVOL(1, value); break;
			case 0x0BA: AMIGA.audio.AUDxDAT(1, value); break;

			case 0x0C0: AMIGA.audio.AUDxLCH(2, value); break;
			case 0x0C2: AMIGA.audio.AUDxLCL(2, value); break;
			case 0x0C4: AMIGA.audio.AUDxLEN(2, value); break;
			case 0x0C6: AMIGA.audio.AUDxPER(2, value); break;
			case 0x0C8: AMIGA.audio.AUDxVOL(2, value); break;
			case 0x0CA: AMIGA.audio.AUDxDAT(2, value); break;

			case 0x0D0: AMIGA.audio.AUDxLCH(3, value); break;
			case 0x0D2: AMIGA.audio.AUDxLCL(3, value); break;
			case 0x0D4: AMIGA.audio.AUDxLEN(3, value); break;
			case 0x0D6: AMIGA.audio.AUDxPER(3, value); break;
