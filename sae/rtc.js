...
function RTC() {
	...
	this.load8 = function (addr) {
		...
		if (AMIGA.config.rtc.type == SAEV_Config_RTC_Type_MSM6242B) {
			switch (addr) {
				case 0x0: return t.getSeconds() % 10;
				case 0x1: return Math.floor(t.getSeconds() / 10);
				case 0x2: return t.getMinutes() % 10;
				case 0x3: return Math.floor(t.getMinutes() / 10);
				case 0x4: return t.getHours() % 10;
				case 0x5: return Math.floor(t.getHours() / 10);
				case 0x6: return t.getDate() % 10;
				case 0x7: return Math.floor(t.getDate() / 10);
				case 0x8: return (t.getMonth() + 1) % 10;
				case 0x9: return Math.floor((t.getMonth() + 1) / 10);
				case 0xA: return (t.getFullYear() - 1900) % 10;
				case 0xB: return Math.floor((t.getFullYear() - 1900) / 10); 
				case 0xC: return t.getDay();
